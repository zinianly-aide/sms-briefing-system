...
-- Default demo user: password is 1234
INSERT IGNORE INTO user (username, password, display_name, role) VALUES
('demo', '$2a$10$EqKcp1WFKyMnIBJCBqhXWexJHbZB/8JvPQXvXyLLOZvMtXQ2mZQEq', '演示用户', 'user');

-- Sample templates
INSERT IGNORE INTO briefing_template (name, category, content, status, owner) VALUES
('暴雨预警模板', '预警', '【暴雨预警】请注意安全，避免外出，做好防汛准备。', '启用中', '系统'),
('台风预警模板', '预警', '【台风预警】台风即将来临，请做好防护准备，关好门窗。', '启用中', '系统'),
('会议通知模板', '通知', '【会议通知】请于今日下午2点参加紧急会议，地点：会议室A。', '启用中', '运营'),
('节假日祝福模板', '祝福', '祝您节日快乐，阖家幸福！', '启用中', '运营');

-- Sample groups
INSERT IGNORE INTO contact_group (name, owner_dept, member_count, tags, status) VALUES
('全员通知群', '综合办公室', 0, '全员,通知', '启用'),
('应急响应群', '安全管理部', 0, '应急,核心', '启用'),
('技术团队群', '技术研发部', 0, '技术', '启用');
